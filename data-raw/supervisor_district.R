...
# save to DB
write.csv(fairfax_dmg_dt_geo_long,"~/Github/dc.sdad.demographics/data/va059_spd_sdad_2019_demographics.csv", row.names = FALSE)
...
# save to DB
write.csv(ookla_fairfax_dt_wide_long_2019,"~/Github/dc.ookla.broadband/data/va059_spd_sdad_2019_speed_measurements.csv", row.names = FALSE)
write.csv(ookla_fairfax_dt_wide_long_2020,"~/Github/dc.ookla.broadband/data/va059_spd_sdad_2020_speed_measurements.csv", row.names = FALSE)
write.csv(ookla_fairfax_dt_wide_long_2021,"~/Github/dc.ookla.broadband/data/va059_spd_sdad_2021_speed_measurements.csv", row.names = FALSE)
