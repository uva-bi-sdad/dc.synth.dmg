...
sf::sf_use_s2(FALSE)
fairfax_acs_supervisor_district <- st_join(geo_infos, fairfax_housing_units_cnts_dmgs_dt_wide_geo, join = st_intersects)

# Estimate the result by human services regions
fairfax_supervisor_district <- fairfax_acs_supervisor_district %>%
...
plot(fairfax_supervisor_district['amr_ind_alone'])