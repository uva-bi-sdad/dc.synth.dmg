...
# Cast long
fairfax_human_services_regions_dt_long <-  melt(setDT(fairfax_human_services_regions_dt), id.vars = c("geoid"))
fairfax_human_services_regions_dt_long$year <- 2019
fairfax_human_services_regions_dt_long$state <- "51"
fairfax_human_services_regions_dt_long$county <- "059"
fairfax_human_services_regions_dt_long$geography <- "human services regions"

# change variable position and rename
fairfax_human_services_regions_dt_long <- fairfax_human_services_regions_dt_long %>% select(year,state,county,geography,variable,value)
colnames(fairfax_human_services_regions_dt_long) <- c("year", "state", "county", "geography", "variables","value")
