...
# upload the data
fairfax_parcels_blocks <- readRDS("~/Github/vdh/dc.synth.dmg/data-raw/fairfax_data/fairfax_parcels_blocks_wgs84.RDS") %>% dplyr::select(PIN,GEOID20,HOUSING20,POP20)

fairfax_housing_units <- read.csv('~/Github/vdh/dc.synth.dmg/data-raw/fairfax_data/Tax_Administration_s_Real_Estate_Fairfax.csv') %>% dplyr::select(PARID,LIVUNIT)
