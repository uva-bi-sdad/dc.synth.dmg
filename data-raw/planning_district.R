...
sf::sf_use_s2(FALSE)
fairfax_acs_planning_districts <- st_join(geo_infos, fairfax_housing_units_cnts_dmgs_dt_wide_geo, join = st_intersects)

# Estimate the result by human services regions
fairfax_planning_districts <- fairfax_acs_planning_districts %>%
...
plot(fairfax_planning_districts['amr_ind_alone'])