...
# merge the two data
fairfax_planning_district_dt <- merge(dmg_fairfax_dt_wide, ookla_fairfax_dt_wide, by="geoid")

# Cast long
fairfax_planning_district_dt_long <-  melt(setDT(fairfax_planning_district_dt), id.vars = c("geoid"))
fairfax_planning_district_dt_long$year <- 2019
fairfax_planning_district_dt_long$state <- "51"
fairfax_planning_district_dt_long$county <- "059"
fairfax_planning_district_dt_long$geography <- "planning districts"

# change variable position and rename
fairfax_planning_district_dt_long <- fairfax_planning_district_dt_long %>% select(year,state,county,geography,variable,value)
colnames(fairfax_planning_district_dt_long) <- c("year", "state", "county", "geography", "variables","value")
