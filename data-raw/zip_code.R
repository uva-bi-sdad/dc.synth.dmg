...
sf::sf_use_s2(FALSE)
fairfax_acs_zip_code <- st_join(geo_infos, fairfax_housing_units_cnts_dmgs_dt_wide_geo, join = st_intersects)

# Estimate the result by human services regions
fairfax_zip_code <- fairfax_acs_zip_code %>%
...
plot(fairfax_zip_code['asian_alone'])
